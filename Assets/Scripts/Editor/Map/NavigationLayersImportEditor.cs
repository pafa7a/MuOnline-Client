...
public class NavigationLayersImportEditor : MonoBehaviour
{
    ...
    [MenuItem("Assets/MuOnline/Import navigation layers", false, 1401)]
    private static void UpdateNavMesh()
    {
        ...
        {
            Debug.LogError("❌ Please select a valid NavigationLayers.txt file.");
            return;
        }
