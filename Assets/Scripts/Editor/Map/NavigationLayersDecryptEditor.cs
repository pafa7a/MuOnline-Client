...
public class NavigationLayersDecryptEditor : MonoBehaviour
{
    ...
    [MenuItem("Assets/MuOnline/Decrypt navigation layers (.att)", false, 1400)]
    private static void DecryptTerrainAttribute()
    {
        ...
        string outputFilePath = Path.Combine(Path.GetDirectoryName(path), "NavigationLayers" + ".txt");
