...
public class ObjectsDecryptorEditor
{
    private static readonly byte[] byObjectXorKey = { 0xD1, 0x73, 0x52, 0xF6, 0xD2, 0x9A, 0xCB, 0x27,
                                                      0x3E, 0xAF, 0x59, 0x31, 0x37, 0xB3, 0xE7, 0xA2 };

    [MenuItem("Assets/MuOnline/Decrypt object file (.obj)", false, 1200)]
    private static void DecryptSelectedObjectFile()
    {
        ...
        string outputPath = Path.Combine(Path.GetDirectoryName(filePath), "Objects.txt");
