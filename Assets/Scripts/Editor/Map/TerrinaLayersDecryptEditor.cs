...
public class TerrinaLayersDecryptEditor
{
    ...
    [MenuItem("Assets/MuOnline/Decrypt map file (.map)", false, 1100)]
    private static void DecryptSelectedMapFile()
    {
        ...
        string outputPath = Path.Combine(Path.GetDirectoryName(filePath), "TerrainLayers.txt");
